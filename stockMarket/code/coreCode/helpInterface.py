...
class HelpInterface:
    def __init__(self):
        ...
        self.scroll = sTk.ScrolledText(self.rootWin, font="Helvetica")
        ...
        \tIn our game, the user acts as an investor, but dividends are not  paid out. Instead, the user must solely attempt to increase the value of their shares through strategic purchases and sales.
